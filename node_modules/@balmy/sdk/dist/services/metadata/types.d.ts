...
export type MetadataResult<TokenMetadata extends object, Requirements extends FieldsRequirements<TokenMetadata> = DefaultRequirements<TokenMetadata>> = BasedOnRequirements<TokenMetadata, Requirements>;
...
export type MergeMetadata<Sources extends IMetadataSource<object>[] | []> = UnionMerge<{
    [K in keyof Sources]: ExtractMetadata<Sources[K]>;
}[number]>;
