import { PermitData, SinglePermitParams } from '../permit2';
...
export type DCAPositionAction = {
    tx: DCATransaction;
} & ActionType;
export declare enum ActionTypeAction {
    CREATED = "created",
    MODIFIED = "modified",
    WITHDRAWN = "withdrawn",
...
export type ActionType = CreatedAction | ModifiedAction | WithdrawnAction | TerminatedAction | TransferredAction | PermissionsModifiedAction | SwappedAction;
...
export type TokenVariant = {
    id: TokenVariantId;
} & (TokenVariantOriginal | TokenVariantWrapper | TokenVariantYield);
export type TokenVariantOriginal = {
    type: 'original';
};
export type TokenVariantWrapper = {
    type: 'wrapper';
};
export type TokenVariantYield = {
    type: 'yield';
    apy: number;
    platform: string;
    tvl: number;
...
export declare enum DCAPermission {
    INCREASE = "INCREASE",
    REDUCE = "REDUCE",
    WITHDRAW = "WITHDRAW",
    TERMINATE = "TERMINATE"
}
export declare enum DCASwapInterval {
    ONE_MINUTE = 60,
    FIVE_MINUTES = 300,
    FIFTEEN_MINUTES = 900,
    THIRTY_MINUTES = 1800,
...
export type ReduceDCAPositionParams = {
    ...
    reduce: {
        amount: BigIntish;
        convertTo?: TokenAddress;
        swapConfig?: DCAActionSwapConfig;
    };
    recipient: Address;
    permissionPermit?: DCAPermissionPermit;
    dcaHub?: Address;
...
export type TerminateDCAPositionParams = {
    ...
    positionId: BigIntish;
    withdraw: {
        unswappedConvertTo?: TokenAddress;
        swappedConvertTo?: TokenAddress;
        swapConfig?: DCAActionSwapConfig;
    };
    recipient: Address;
    permissionPermit?: DCAPermissionPermit;
...
export type MigrateDCAPositionParams = {
    ...
    migration: PositionMigration & {
        newFrom?: PositionToken;
        newTo?: PositionToken;
        swapConfig?: DCAActionSwapConfig;
    };
};
type PositionMigration = {
    useFundsFrom: 'swapped' | 'unswapped';
    sendUnusedFundsTo: Address;
} | {
    useFundsFrom: 'both';
    sendUnusedFundsTo?: undefined;
};
export type DCAActionSwapConfig = {
