...
import { CompareQuotesBy, CompareQuotesUsing, EstimatedQuoteRequest, EstimatedQuoteResponse, SourceId, SourceMetadata, QuoteTransaction } from '../quotes';
import { SupportedGasValues } from '../gas/types';
import { IgnoreFailedResponses, QuoteResponseWithTx } from '../quotes/types';
import { Contract } from '../../shared/contracts';
export type IPermit2Service = {
    permit2Contract: Contract;
    arbitrary: IPermit2ArbitraryService;
    quotes: IPermit2QuoteService;
    calculateNonce(params: {
        chainId: ChainId;
        appId: BigIntish;
        user: Address;
    }): Promise<bigint>;
...
export type IPermit2QuoteService = {
    ...
    buildAndSimulateQuotes<IgnoreFailed extends boolean = true>(_: {
        chainId: ChainId;
...
export type GenericSinglePermitParams = {
    spender: Address;
} & SinglePermitParams;
...
export type GenericBatchPermitParams = {
    spender: Address;
} & BatchPermitParams;
...
export type GenericContractCall = (EncodedContractCall | ContractCall) & {
    value?: BigIntish;
};
