...
class QuoteService {
    ...
    async getAllQuotes({ request, config, }) {
        ...
        const quotes = Object.entries(this.getQuotes({ request, config })).map(([sourceId, response]) => handleResponseFailure(sourceId, response, metadata));
...
function handleResponseFailure(sourceId, response, sources) {
