import { IQuoteSource, QuoteParams, QuoteSourceMetadata, QuoteSourceSupport, SourceQuoteResponse, SourceQuoteTransaction, BuildTxParams } from '../types';
export declare abstract class AlwaysValidConfigAndContextSource<Support extends QuoteSourceSupport, CustomQuoteSourceConfig extends object = {}, CustomQuoteSourceData extends Record<string, any> = Record<string, any>> implements IQuoteSource<Support, CustomQuoteSourceConfig, CustomQuoteSourceData> {
