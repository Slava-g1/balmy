...
import { BaseTokenMetadata } from '../../metadata/types';
...
export type BuildTxParams<CustomQuoteSourceConfig extends object = {}, CustomQuoteSourceData extends Record<string, any> = Record<string, any>> = {
    components: QuoteComponents;
    config: CustomQuoteSourceConfig & GlobalQuoteSourceConfig;
...
export type IQuoteSource<Support extends QuoteSourceSupport, CustomQuoteSourceConfig extends object = {}, CustomQuoteSourceData extends Record<string, any> = Record<string, any>> = {
...
export type SourceQuoteRequest<Support extends QuoteSourceSupport, Order extends ConfigurableOrder<Support> = ConfigurableOrder<Support>, Accounts extends ConfigurableAccounts<Support> = ConfigurableAccounts<Support>> = BaseSwapQuoteRequest<Order, Accounts>;
type ConfigurableOrder<Support extends QuoteSourceSupport> = IsBuyOrder<Support> extends true ? SellOrder | BuyOrder : SellOrder;
type ConfigurableAccounts<Support extends QuoteSourceSupport> = IsSwapAndTransfer<Support> extends true ? BaseSwapAccounts & {
    recipient?: Address;
} : BaseSwapAccounts;
