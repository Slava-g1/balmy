import { GasSpeed, SupportedGasValues } from '../gas/types';
...
export type IQuoteService = {
    ...
    supportedSourcesInChain(_: {
        chainId: ChainId;
    }): Record<SourceId, SourceMetadata>;
    ...
    }): Record<SourceId, Promise<EstimatedQuoteResponse>>;
    ...
    buildAllTxs<IgnoreFailed extends boolean = true>(_: {
        quotes: Record<SourceId, Promise<QuoteResponseRelevantForTxBuild>> | Promise<Record<SourceId, QuoteResponseRelevantForTxBuild>> | Record<SourceId, QuoteResponseRelevantForTxBuild>;
        sourceConfig?: SourceConfig;
        config?: {
            timeout?: TimeString;
            ignoredFailed?: IgnoreFailed;
...
type TokenWithOptionalPrice = BaseTokenMetadata & {
...
export type QuoteResponseWithTx<CustomQuoteSourceData extends Record<string, any> = Record<string, any>> = QuoteResponse<CustomQuoteSourceData> & {
    tx: QuoteTransaction;
};
...
export type EstimatedQuoteResponse<CustomQuoteSourceData extends Record<string, any> = Record<string, any>> = Omit<QuoteResponse<CustomQuoteSourceData>, 'accounts'>;
